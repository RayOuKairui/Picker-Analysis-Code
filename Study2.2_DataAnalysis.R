# =============================================================================
# Study 2.2 — Data Analysis ("Told" vs. "Heard" follow-up, replication)
# -----------------------------------------------------------------------------
# Second follow-up to Study 2, same design as Study 2.1 on a new sample. Each
# participant responded about several secret categories (the X1 grouping
# variable). For each category there are epistemic items (1-3) and relational
# items (4-6), measured in a told and/or heard frame. The script:
