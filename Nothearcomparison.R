# =============================================================================
# NOT-HEARD SECRETS — DEDUCTIVE CLASSIFICATION INTO PREDEFINED CATEGORIES
# -----------------------------------------------------------------------------
# Unlike the inductive theme-coding pipeline (Nothear_Coding_Complete.R), this
# script classifies each "not heard" secret into a FIXED set of 20 predefined
# categories (from Category_wording.docx), then mines the leftovers for possible
# new categories.
#
...
#
# Inputs : secretsnothear_long_form_sorted.csv
# Outputs: nothear_coded.csv            (every response + assigned category)
#          nothear_classification.xlsx  (coded data, frequencies, unfit, proposals)
#
...
df <- read_csv("secretsnothear_long_form_sorted.csv",
...
progress_file <- "nothear_coded_progress.csv"
...
write_csv(coded, "nothear_coded.csv")
...
saveWorkbook(wb, "nothear_classification.xlsx", overwrite = TRUE)
cat("\nSaved: nothear_classification.xlsx\n")
